...
2. 众筹阶段：获得足够声誉投票后激活
3. 执行阶段：自主运作，定期向网络报告
4. 解散阶段：交付成果，成员获得声誉奖励，财务自动结算，该时限不得超过30日。
...
- 所有决策上链，不可篡改，全民可查
- 声誉系统记录每个参与者的贡献与失误
- 严重失职：声誉清零并触发全民投票决定是否限制其未来参与权，该时限不得超过30日。
...
b) 占有型→封闭系统
c) 冷漠型→隔离区域+缓冲层
d) 混合型→按权重分配，该时限不得超过30日。

**规则 I.4.2.048【标签不可篡改】**
能源属性标签一旦生成，不可单方面篡改。修改需经能源院审批应当。
